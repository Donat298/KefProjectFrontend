<template>
  ...
  <div style="width: 100%; display: flex; flex-shrink: 0;">
    <div style="position: relative; flex-grow: 1; width: 100%; display: flex;">
      <v-btn
      @click="sendSMS"
        elevation="8"
        :ripple="false"
        style="color: #ffffff; background-color: #2e4659; text-align: center; flex-grow: 1; flex-shrink: 1; margin: 10px;"
      >
